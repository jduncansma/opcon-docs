...
The parent element \<vms_exit_info\> contains the child elements needed
...
-   **Valid Values**: Valid data characters for this element are
  ...
  -------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [The pound sign (\#) must be used in the first character in order to qualify.]
  -------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------
...
-   **Valid Values**: Valid data for this element is an existing token
  ...
  -------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [Do not include the surrounding double brackets (\[\[ \]\]) when listing the OpCon Token Name.]
  -------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------
...
-   **EM field label**: Job Name
  ...
  -------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [If you are defining a job for Tracking, you do not have to define the \<sap_jobname\>. In this case, the OpCon Job Name is required.]
  -------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------------------
...
field for this job type, refer to [SQL Job Details](../../Concepts/SQL-Job-Details.md) in the
**Concepts** online help.
...
**  \-\-\-\-\--**[Job Information Element Definitions](#Job9){.MCXref
.xref}**\-\-\-\-\--**

   \<sql_job_action\>\</sql_job_action\>

**  \-\-\-\-\--**[MS SQL DTExec Element Definitions](#MS){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[MS SQL Job Element Definitions](#MS2){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[MS SQL Script Element Definitions](#MS3){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[MySQL Element Definitions](#MySQL){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[Oracle Element Definitions](#Oracle){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[Other DB Element Definitions](#Other){.MCXref
.xref}**\-\-\-\-\--**
...
each field for this job type, refer to [Tuxedo ART Job Details](../../Concepts/Tuxedo-ART-Job-Details.md)
...
each field for this job type, refer to [UNIX Job Details](../../Concepts/UNIX-Job-Details.md) in the
**Concepts** online help.
...
on each field for this job type, refer to [Windows Job Details](../../Concepts/Windows-Job-Details.md) in
the **Concepts** online help.
...
**  \-\-\-\-\--**[Job Information Element Definitions](#Job4){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[Exit Code Element Definitions](#Exit){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[Prerun Job Element Definitions](#Prerun7){.MCXref
.xref}**\-\-\-\-\--**
...
each field for this job type, refer to [z/OS Job Details](../../Concepts/zOS-Job-Details.md) in the
**Concepts** online help.
...
**  \-\-\-\-\--**[Job Information Element Definitions](#Job3){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[Token Equation Element Definitions](#Token){.MCXref
.xref}**\-\-\-\-\--**

   \<token\>\</token\>

**  \-\-\-\-\--**[Step Control Element Definitions](#Step){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[File Prerun Element Definitions](#File2){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[Message Prerun Element Definitions](#Message2){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[Task Prerun Element Definitions](#Task){.MCXref
.xref}**\-\-\-\-\--**
...
**  \-\-\-\-\--**[Tape Prerun Element Definitions](#Tape){.MCXref
.xref}**\-\-\-\-\--**
...
-   **Valid Values**: Valid data characters for this element are
  ...
  -------------------------------------------------------------------------------------------------------------------------------- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [Tokens should also be allowed. Although brackets are invalid characters, the string \[\[xxxx\]\] should be allowed where xxxx equals any character set.]
  -------------------------------------------------------------------------------------------------------------------------------- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-   **Valid Values**: Valid values include **From Any LSAM** or
  ...
  -------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [Primary LSAM refers to the LSAM/PSAM on which the job is scheduled. It should not be confused with a \"gateway LSAM\" in a SYSPLEX group.]
  -------------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-   **Valid Values**: The value may be *a one- to four-character string
  ...
  -------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [The File Prerun, Message Prerun, Task Prerun, Tape Prerun, and REXX Preruns use this one element to determine the machine ID. If the element is not specified, all of the preruns run on the Primary Machine ID.]
  -------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-   **Valid Values**: Each name may contain alphabetic, national, and
  ...
  -------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [The step names can be found, in reverse order, on the MVS IEF142I message (i.e., the message displaying the execstep followed by the jobstep).]
  -------------------------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-   **Valid Values**: The value of event_type must be Batch Job, Started
  ...
  -------------------------------------------------------------------------------------------------------------------------------- ----------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [If the step_min is specified, step_max must also be specified.]
  -------------------------------------------------------------------------------------------------------------------------------- ----------------------------------------------------------------------------------------
...
-   **Valid Values**: The event_type can be any value.
  ...
  -------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [The Job Name field does not apply to File Exists conditions.]
  -------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------

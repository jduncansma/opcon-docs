...
Leave the value set to **Disabled** if [SMA Technologies]{.GeneralCompanyName} should not be automatically notified
through email when:
...
9.  Click the **Save**
    ![](../../Resources/Images/Installation/EMsave.png) button on the
    **Machines** toolbar.

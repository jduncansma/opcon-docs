...
+------------------------------+--------------------------------------+
| JI.\$DEPARTMENT NAME         | Resolves to the name of the          |
...
table.
  ...
  : Managed System Property Defaults
...
|            | \'A\' with any hour before noon; substitute an         |
...
+------------+--------------------------------------------------------+
| yyyy       | Substitute the year as a four-digit number (100 --     |
|            | 9999). Examples:                                       |
|            |                                                        |

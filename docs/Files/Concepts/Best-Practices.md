...
-   [Add Documentation to Thresholds and Properties](#Add){.MCXref
    .xref}
...
-   [Check Job Dependencies that cannot be resolved](#Check){.MCXref
    .xref}
-   [Receive an alert when Machines stop working](#Receive){.MCXref
    .xref}
-   [Receive an alert when SAM is not running](#Receive2)
-   [Run a Windows Job under a different User Account](#Run){.MCXref
    .xref}
...
[SMA Technologies]{.GeneralCompanyName} provides a database file called **SMAReports.mdb** that can be imported into
...
For more information, refer to [Schedule Import/Export](../Utilities/Graphical-Utilities/Schedule-Import_Export.md){.MCXref
...
date**.
  ...
  ----------------------------------------------------------------------------------------------------------------------------- ---------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [By default, all of these jobs are disabled.]
  ----------------------------------------------------------------------------------------------------------------------------- ---------------------------------------------------------------------
...
Add a **frequency** to this job (e.g., Daily).
  ...
  ----------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [Ensure that this job is included in built schedules already existing for the future.]
  ----------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------
...
within the **FailedJobsbyDate.cmd** file.
  ...
  ----------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [Ensure that this job has write access to the new directory.]
  ----------------------------------------------------------------------------------------------------------------------------- -------------------------------------------------------------------------------------

 

  ----------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [The Output Directory was configured during installation. For more information, refer to the [File Locations](File-Locations.md) section in this online help.]
  ----------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
on the jobs in the SMAUtility Schedule, refer to [SMAUtility Schedule](SMAUtility-Schedule.md).
...
1.  Create a Global Property for the full path to your programs on the
    server. For more information, refer to [Adding Global     Properties](../UI/Enterprise-Manager/Adding-Global-Properties.md){.MCXref
...
2.  Use a token to access the Global Property anytime you are defining a
    ...
    refer to [Using Properties for     Automation](Using-Properties-for-Automation.md){.MCXref
    .xref}. In the screen below, the \[\[OPCON-SCRIPTS\]\] token is in     the place of the path to the FileRename.cmd file.

Global Properties

![Global Properties](../../Resources/Images/Concepts/EMglobalproperty.png "Global Properties"){.dropshadow}

OpCon Job Master (Details)

![OpCon Job Master (Details)](../../Resources/Images/Concepts/bestpracjobdet.png "OpCon Job Master (Details)"){.dropshadow}
...
[DoBatch](../Utilities/Command-line-Utilities/DoBatch.md#DoBatch){.MCXref
.xref} in the **Utilities** online help then go to DoBatch
[Checking](../Utilities/Command-line-Utilities/DoBatch.md#Checking){.MCXref
.xref} to create a command file containing the DoBatch program and the
CHECK parameter.
...
trigger) notifications. Refer to [Monitored Events](zOS-Job-Details.md#Monitore).
...
refer to [Hung Script Configuration](../Server-Programs/SMA-Service-Manager.md#Hung_Script_Configuration){.MCXref
...
Users](../UI/Enterprise-Manager/Adding-Batch-Users.md){.MCXref
.xref} in the **Enterprise Manager** online help.
...
1.  Set a [Late to Start]{.skd-job-statuses} value for the Container     job. For more information, refer to the **Late to Start** value
    under [Job Automation     Components](Job-Automation-Components.md#Late).
...
3.  Set a [Late to Start]{.skd-job-statuses} value for the jobs in the     subschedule. For more information, refer to the **Late to Start**
    value under [Job Automation     Components](Job-Automation-Components.md#Late).
...
b.  For MCP, the machine count in the Enterprise Manager ought to be
    ...
    [Interactive LSAM     Window](https://help.smatechnologies.com/opcon/agents/mcp/latest/Files/Agents/MCP/Interactive-LSAM-Window.md){.MCXref
    .xref} in the **MCP LSAM** online help.
c.  For MSLSAM, refer to [Check for Running     Jobs](https://help.smatechnologies.com/opcon/agents/windows/latest/Files/Agents/Microsoft/Upgrading-from-a-Release-Prior-to-15.0.md#Check_for_Running_Jobs){.MCXref
...
f.  For SAP BW, refer to [Check for Running     Jobs](https://help.smatechnologies.com/opcon/agents/sapbw/latest/Files/Agents/SAP-BW/Upgrade-Installation.md#Check_for_Running_Jobs){.MCXref
    .xref} in the **SAP BW LSAM** online help.
g.  For SAP R3 and CRM, refer to [Check for Running     Jobs](https://help.smatechnologies.com/opcon/agents/sap/latest/Files/Agents/SAP/Upgrade-Installation.md#Check_for_Running_Jobs){.MCXref
    .xref} in the **SAP LSAM** online help.
...
a.  For IBM i, refer to [IBM i Procedures to shut down a     Machine](#IBM_i_Procedures_to_shut_down_a_Machine).
b.  For MCP, refer to [Stop the LSAM and Resource     Monitor](https://help.smatechnologies.com/opcon/agents/mcp/latest/Files/Agents/MCP/Automated-Installation-Upgrade.md#Stop_the_LSAM_and_Resource_Monitor){.MCXref
    .xref} in the **MCP LSAM** online help.
c.  For MSLSAM, refer to [Stop the     Service](https://help.smatechnologies.com/opcon/agents/windows/latest/Files/Agents/Microsoft/Upgrading-from-a-Release-Prior-to-15.0.md#Stop_the_Service){.MCXref
    .xref} in the **Microsoft LSAM** online help.
d.  For OpenVMS, refer to [Stopping the     LSAM](https://help.smatechnologies.com/opcon/agents/openvms/latest/Files/Agents/OpenVMS/Starting-and-Stopping-the-LSAM.md#Stopping_the_LSAM){.MCXref
    .xref} in the **OpenVMS LSAM** online help.
e.  For OS 2200 and BIS, refer to [Stopping the     LSAM/LMAM](https://help.smatechnologies.com/opcon/agents/os2200/latest/Files/Agents/OS-2200/Components-and-Operation.md#Stopping_the_LSAM/LMAM){.MCXref
    .xref} in the **OS 2200 LSAM** online help.
f.  For SAP BW, refer to [Stop the     Service](https://help.smatechnologies.com/opcon/agents/sapbw/latest/Files/Agents/SAP-BW/Upgrade-Installation.md#Stop_the_Service){.MCXref
    .xref} in the **SAP BW LSAM** online help.
g.  For SAP R3 and CRM, refer to [Stop the     Service](https://help.smatechnologies.com/opcon/agents/sap/latest/Files/Agents/SAP/Upgrade-Installation.md#Stop_the_Service){.MCXref
    .xref} in the **SAP LSAM** online help.
h.  For UNIX, refer to [Stop the     LSAM](https://help.smatechnologies.com/opcon/agents/unix/latest/Files/Agents/UNIX/Operating-the-LSAM.md#Stop_the_LSAM){.MCXref
...
b.  For MCP, from the MARC Main Menu action line, enter the following
    ...
    results to look for, refer to [Check LSAM     Status](https://help.smatechnologies.com/opcon/agents/mcp/latest/Files/Agents/MCP/LSAM-Operation.md#Checking_LSAM_Status){.MCXref
    .xref} in the **MCP LSAM** online help.
c.  For MSLSAM, refer to [Procedures to Check LSAM Status on     Windows](#Procedures_to_Check_LSAM_Status_on_Windows){.MCXref
    .xref}.
d.  For OpenVMS, refer to [Checking LSAM     Status](https://help.smatechnologies.com/opcon/agents/openvms/latest/Files/Agents/OpenVMS/Starting-and-Stopping-the-LSAM.md#Checking_LSAM_Status){.MCXref
    .xref} in the **OpenVMS LSAM** online help.
e.  For OS 2200 and BIS, refer to [Checking LSAM/LMAM     Status](https://help.smatechnologies.com/opcon/agents/os2200/latest/Files/Agents/OS-2200/Components-and-Operation.md#Checking_LSAM/LMAM_Status){.MCXref
    .xref} in the **OS 2200 LSAM** online help.
f.  For SAP BW, refer to[Procedures to Check LSAM Status on     Windows](#Procedures_to_Check_LSAM_Status_on_Windows){.MCXref
    .xref}.
g.  For SAP R3 and CRM, refer to [Procedures to Check LSAM Status on     Windows](#Procedures_to_Check_LSAM_Status_on_Windows){.MCXref
    .xref}.
h.  For UNIX, refer to [Check the LSAM     Status](https://help.smatechnologies.com/opcon/agents/unix/latest/Files/Agents/UNIX/Operating-the-LSAM.md#Check_the_LSAM_Status){.MCXref
    .xref} in the **UNIX LSAM** online help.
...
zero (0). For more information, refer to [Adding Thresholds](../UI/Enterprise-Manager/Adding-Thresholds.md){.MCXref
.xref} in the **Enterprise Manager** online help.

Create the **File Monitor** and **action group** which will update the
threshold. For more information, refer to [Summary Information](../Utilities/SMA-Resource-Monitor/Summary-Information.md){.MCXref
.xref} in the **Utilities** online help.
...
Dependencies](../UI/Enterprise-Manager/Adding-Threshold-and-Resource-Dependencies.md){.MCXref
.xref} in the **Enterprise Manager** online help.

Set a **Late to Start** value for the job. For more information, refer
to the **Late to Start** value under [Late to Start/Late to Finish](Job-Frequency.md#Late).
...
Automation Components](Job-Automation-Components.md#Events){.MCXref
.xref} in this online help or [Using Notification Manager](../UI/Enterprise-Manager/Using-Notification-Manager.md){.MCXref
.xref} in the **Enterprise Manager** online help.
...
Updates](../UI/Enterprise-Manager/Adding-Threshold-and-Resource-Updates.md){.MCXref
.xref} in the **Enterprise Manager** online help.
:::

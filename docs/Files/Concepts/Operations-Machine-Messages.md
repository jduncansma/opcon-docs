...
 
  ...
  ----------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [Do not confuse these codes with UNIX System Exit Codes. LSAM Exit Codes come from the UNIX LSAM itself while UNIX System Exit Codes come from the UNIX operating system.]
  ----------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Codes](https://help.smatechnologies.com/opcon/agents/unix/latest/Files/Agents/UNIX/Completed-Jobs-and-LSAM-Exit-Codes.md){.MCXref
...
error. [SMA Technologies]{.GeneralCompanyName} recommends: 
...
|                     |             | UNIX/sma_ppscript.md){.MCXref |
|                     |             | .xref} in the **UNIX LSAM**    |
|                     |             | online help.                   |
+---------------------+-------------+--------------------------------+

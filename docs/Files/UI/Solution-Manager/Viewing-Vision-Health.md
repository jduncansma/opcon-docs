...
![Vision Health Page](../../../Resources/Images/SM/Vision-Health-Page.png "Vision Health Page"){.dropshadow}
...
![Vision Diagnostic Page](../../../Resources/Images/SM/Vision-Diagnostic-Page.png "Vision Diagnostic Page"){.dropshadow}
...
-   **Blue**: The threshold level set for the card is unknown. There are
  ...
  -------------------------------------------------------------------------------------------------------------------------------- ----------------------------------------------------------------------------------------------------------------------------
  ![White pencil/paper icon on gray circular background](../../../Resources/Images/note-icon(48x48).png "Note icon")   **NOTE:** [The colored bullets are indicators that a card is selected and have nothing to do with thresholds.]
  -------------------------------------------------------------------------------------------------------------------------------- ----------------------------------------------------------------------------------------------------------------------------
:::
